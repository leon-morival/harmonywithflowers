        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-md shadow-lg p-6 mb-8">
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="lg:w-1/2">
                        <h2 class="text-2xl font-semibold text-gray-800 mb-6">Bach Flowers</h2>
                ...
                <div class="flex flex-col lg:flex-row">
                    ...
                    <div class="lg:w-1/2">
                        <img src="{{ asset('bach_img/qualification.png') }}" alt="Bach Flower Practitioner"
                            class="w-full h-64 object-cover  mb-6 lg:mb-0 lg:mr-6">
                    </div>
            ...
            <div class="bg-white rounded-md shadow-lg p-6">
                ...
                <div class="flex justify-center">
                    <a href="{{ route('appointments') }}"
                        class="inline-block px-6 py-2 text-center text-white bg-blue-600 hover:bg-blue-700 rounded-md">
                        Book Bach Flowers
                    </a>
                </div>
            </div>
