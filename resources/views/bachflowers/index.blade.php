...
<x-app-layout>
    <section class="py-12 lg:px-12 md:px-3">
        <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gray-100 rounded-lg p-4">
                        <a href="{{ route('bachflowers.oversensitivity') }}">
                            <h4 class="text-xl font-semibold text-gray-800 mb-4 text-center">Over-sensitivity to
                    ...
                    <div class="bg-gray-100 rounded-lg p-4">
                        <a href="{{ route('bachflowers.overcare') }}">
                            ...
                            <h4 class="text-xl font-semibold text-gray-800 mb-4 text-center">Over-care for the welfare
                                of others</h4>
                    ...
                    <div class="bg-gray-100 rounded-lg p-4">
                        <a href="{{ route('bachflowers.despondency') }}">
                            ...
                            <h4 class="text-xl font-semibold text-gray-800 mb-4 text-center">Despondency or despair
                            </h4>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
                <div class="flex flex-col lg:flex-row">
                    <!-- Qualification Image -->
                    <div class="lg:w-1/2">
                        <img src="{{ asset('bach_img/qualification.png') }}" alt="Bach Flower Practitioner"
